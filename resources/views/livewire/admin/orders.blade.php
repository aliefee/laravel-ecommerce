		...
		<table class="min-w-full table-auto">
			...
			<tbody class="bg-gray-200">
				...
				<tr class="bg-white border-4 border-gray-200">
					...
					<td class="px-16 py-2">
						<span class="text-center ml-2">{{ $order->created_at }}</span>
					</td>
					<td class="px-16 py-2">
					...
					<td class="px-16 py-2">
						<button class="bg-red-500 hover:bg-red-700 text-sm text-white px-2 py-2 border rounded-md hover:text-black focus:outline-none focus:shadow-outline">
						Cancel Order
						</button>
					</td>
				</tr>

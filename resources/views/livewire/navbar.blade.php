            ...
            <div class="container mx-auto px-6 py-3">
                <div class="flex items-center justify-between">
                    <div class="hidden w-full text-gray-600 md:flex md:items-center">
                        ...
                        <span class="mx-1 text-sm">Istanbul</span>
                    </div>
                    <div class="w-full text-gray-700 md:text-center text-2xl font-semibold">
                        Brand
                    </div>
                    <div class="flex items-center justify-end w-full">
                        <button @click="$dispatch('cart')" class="text-gray-600 focus:outline-none mx-4 sm:mx-0">
                ...
                <nav x-cloak :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                ...
                <div class="relative mt-6 max-w-lg mx-auto">
                    ...
                    <form>
                        <input id="search" class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
                    </form>
                </div>
            </div>
        </header>
...
<script>
    ...
    function search () {
        ...
        window.open("/q?search=" + searchInput, name="_self");
    }
</script>
